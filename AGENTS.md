...
2. **[docs/tasks.md](docs/tasks.md)** - Shared task board with current assignments and status
3. **[docs/decisions.md](docs/decisions.md)** - Active project decisions (tech choices, scope, conventions)
...
4. **Read before you write.** Always check existing code, recent PRs, and `docs/tasks.md` before starting work.
...
1. Read `docs/tasks.md` for available tasks
2. Check open PRs to avoid duplicating effort
3. Claim a task by updating `docs/tasks.md` (set status to `in_progress`, add your name as owner)
